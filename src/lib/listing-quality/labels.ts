...
export const LISTING_CHECK_LABEL: Readonly<Record<string, string>> =
  Object.freeze({
    ...
    'property.guest_rating':
      'אין עדיין מספיק ביקורות כדי לחשב ממוצע. זה מצב של עסק חדש ולא של עסק גרוע, ולכן זה לא מוריד ציון.',
    'property.reviews_hidden':
      'יש ביקורות מוסתרות. הן אינן נכללות בממוצע — ולכן הן מוצגות כאן, כדי שהציון לא ייראה טוב יותר ממה שהאורחים כתבו.',
