...
export const GRANT_CAPABILITY: Partial<Record<Grant, string>> = {
  ...
  'fiscal.resolve': 'טיפול במסמכים חשבונאיים שלא יצאו',
  'guest_book.view': 'צפייה בספר האורחים',
  'guest_book.manage': 'ניהול ספר האורחים',
  'migration.view': 'צפייה בייבוא נתונים ממערכת אחרת',
  'migration.apply': 'ביצוע ייבוא נתונים ממערכת אחרת',
  ...
  'checklist.manage': 'ניהול רשימות ההכנה',
  ...
  'lead.create': 'רישום פניות ולידים',
  'rate.view_public': 'צפייה בתעריפים ובתוכניות המחיר',
