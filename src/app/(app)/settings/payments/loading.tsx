 ...
 *
 * Three panels at the settings width, matching the page: the policy, the
 * channels, the preview. No table skeleton — nothing here is a list of rows.
 */
export default function PaymentSettingsLoading() {
  return (
    <div
      role="status"
      aria-label="טוען את הגדרות הגבייה"
