 ...
 *
 * `h1` is included because a card is sometimes the whole screen — the sign-in
 * page is one card and nothing else, and its title is genuinely the page's
 * first heading. Without this the outline on those screens starts at level two
...
export function CardTitle({
  ...
  className,
  ...props
}: { as?: 'h1' | 'h2' | 'h3' | 'h4' } & ComponentProps<'h3'>) {
  return (
    <Tag
      className={cn(
